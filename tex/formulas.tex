...
when $E_k > O_k$.  In the interactive visualization, they are shown
as ``hints'' on the sliders.  As $\vtheta$ is adjusted, the partial derivatives 
will also gradually change, eventually reaching 0 at the top of the hill, where
