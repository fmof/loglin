...
Thus, the parameters of the model are real numbers like
$\theta_{\textrm{solid}}$.  The larger $\theta_{\textrm{solid}}$ is,
the more the probability distribution favors the solid circle and
solid triangle.  Look back at section~\ref{sec:concrete} of this
handout to see exactly what the probabilities of the 4 shapes are.
