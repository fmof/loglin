...
components: the student interface (front-end), the instuctor's \NoteFF{interface}, and the back-end implementation.
...
generating a new random challenge'' and tweaking regularizaiton, are described more in Section \ref{sec:lessons}.
