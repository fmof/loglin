...
sticks that represent natural numbers, or geoboards\footnote{A board
  representing the plane, with pegs at the integral points.  A rubber
  band is stretched around selected pegs to define a polygon.}
...
\newcite{nouza1999teaching} explored\NoteJE{developed?} VISPER, an applied educational tool that wrapped various speech technologies and 
