...
We summarize the model's quality via the (training) regularized conditional log-likelihood 
\eqref{eqn:reg_ll},
\begin{equation}
...
While mathematically we find $\vec{\theta^*}$ that solves equation \eqref{eqn:grad}:
\begin{equation}
\begin{aligned}
%\begin{split}
\nabla_{\vec{\theta}} F
