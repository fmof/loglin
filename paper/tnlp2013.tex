...
\section{Virtual Manipulative Overview\NoteJE{why just overview?}}\label{sec:overview}
\begin{figure*}
\centering
...
\NoteJE{give the URL at the start of this section}

\NoteJE{move this bit to the end of the section?}
...
Figure \ref{fig:lesson1}\NoteJE{I might prefer a full screenshot
  rather than dividing the view up into pieces.  It's more organic.
  ...
  talking to {\em teachers} here, not to HCI people---the goal is to
