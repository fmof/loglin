...
Given a dataset \Data{} of $N$ context (history) and outcome (event) points $\{( x_i, y_i)\}_{i=1}^N$, we often wish to  estimate conditional models $p(y_i\ \mid\ x_i)$. define empirical distribution
\begin{equation}
