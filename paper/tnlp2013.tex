...
\caption{Colors indicate the sign of \eqref{eqn:obsexp} while a shape's area indicate 
the difference betwen that type's probability under the 
...
The last lesson, \textbf{\NoteFF{FIX ME}}, applies log-linear modeling to the applied task of text categorization (spam detection). We ask questions to make sure they understand what the conditional models actually mean
