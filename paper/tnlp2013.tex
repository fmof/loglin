...
\begin{figure*}
\centering
\includegraphics[scale=.5]{images/lesson1-050913.PNG}
...
This is the primary interaction with the tool for most users and so the interf; Figure \ref{fig:lesson1} provides a sample screenshot.
