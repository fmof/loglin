...
proportions, is a recurring quantity. Though our system encourages students to infer that the feature 
matching and log-likelihood activities are really just the same thing, focusing on this difference as part 
of a larger exploration into the gradient confirms the physical intuitions with mathematical justification.
This difference also shows that, when the outcome matching activity is feasible, matching the empirical 
distribution will generally maximize the (unregularized) log-likelihood. 
