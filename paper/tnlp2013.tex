...
features interact?  When estimating their weights, can raising one
...
computationally (slow convergence of gradient
ascent in some circumstances, or non-convergence if a fixed stepsize
is used)?  How can it go wrong 
...
separate the lessons that build intuition from the ones focused on
specific tasks or problems.  This helps the student solidify the fundamentals and facilitates future development by providing what might be considered 
