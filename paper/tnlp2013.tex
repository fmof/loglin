...
ascent,\footnote{When $\ell_1$ regularization is used, the optimal
  ...
  0.
%\NoteJE{Is this needed for correctness or just efficiency?  I
%    can't think anymore why nondifferentiability is a problem.  Isn't
%    Armijo enough?}  
It stops at 0, though if warranted, it can
 continue past 0 on the next step.} 
...
model is set up and how to generalize it to three-way classification.
